...
<body>
  ...
  <input type="text" id="fname" name="user" readonly="readonly" value="<?php echo $sujet["user"]; ?>"> <br><br>
  <label for="lname">Titre:</label> <br>
  <input type="text" id="lname" name="title"  value="<?php echo $sujet["thread"]; ?>" ><br><br>
  <label for="Contenu"> Contenu </label> <br>
  <textarea name="contents" rows="10" cols="30"  value="<?php echo $sujet["content"]; ?>" ></textarea> <br>

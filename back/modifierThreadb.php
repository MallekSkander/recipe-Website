<?php
    ...
    if (isset($_POST['user']) && isset($_POST['title']) && isset($_POST['contents'])) {
        $comment = new comment($_POST['user'],$_POST['title'], $_POST['contents']);
         
         $commentC->updateCom($comment,$_POST['ID']);
        header('location:tables-bootstrap2.php');
 
      }
    $sujet=$commentC->recupererCom($_POST['ID']);
								...
								<div class="card-body">
									...
									<div class="col-md-6">
										...
										<div class="col-md-4">
											...
											<input type="text" name="user" class="form-control" id="validationCustom01" value="<?php echo $sujet["user"]; ?>" required>
										...
										<div class="col-md-4">
											...
											<input type="text" name="title" class="form-control" id="validationCustom02"  value="<?php echo $sujet["thread"]; ?>" required>
											<div class="valid-feedback">
												Looks good!
											</div>
										</div>
										<div class="col-md-4">
											...
											<div class="input-group">
												...
												<input type="text" name="contents" class="form-control" id="validationCustomUsername" value="<?php echo $sujet["content"]; ?>" aria-describedby="inputGroupPrepend"
													required>
												<div class="invalid-feedback">

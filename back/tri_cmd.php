...
?>  
	...
	<tr>
		...
		<td><?PHP echo $cmd['id_cmd']; ?></td>
		<td><?PHP echo $cmd['id_membre']; ?></td>
		<td><?PHP echo $cmd['montant']; ?></td>
		<td><?PHP echo $cmd['date_enregistrement']; ?></td>
		<td>
						...
						<input type="hidden" value=<?PHP echo $cmd['id_cmd']; ?> name="id_cmd">

...
<div id="content" style="position:relative; left: 500px ; top: 70px">
    ...
    <table>
        ...
        <tr>
            ...
            <td><a class="action" href="<?php echo ('../back/ingredient_edit.php?id=' . h(u($ingredient['id']))); ?>"><i class="far fa-edit edit_button" title="edit"></i></a></td>
            <td><a class="action" href="<?php echo ('../back/ingredient_delete.php?id=' . h(u($ingredient['id']))); ?>"><i class="far fa-trash-alt delete_button" title="delete"></i></a></td>
        </tr>
        <?php } ?>
    </table>
</div>

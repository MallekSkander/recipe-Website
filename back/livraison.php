...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
						...
						<div class="col-12 col-xl-6">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title"> Le tableau des sujets </h5>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th style="width:35%">Numero telephone</th>
											<th style="width:35%">Adresse</th>
											<th>Actions</th>
										</tr>
									</thead>
									<?php 
        foreach ($listeL as $liv) {
            ?> 
									<tbody>
		 ...
		 <td class="d-none d-md-table-cell"><?php echo $liv['num_tel']; ?></td>
	...
	<form action="supprimerLiv.php" method="post">
     ...
     <input type="hidden" name="id" value="<?php echo $liv['id'] ?>">
		</form>

						<form action="forms-validation.php" method="post">
...
<form method="POST" action="rechercheLiv.php">
<br>
<div class="text-center">
<button  class="btn btn-primary" name="imprimer"> Recherche </button>  
</form>

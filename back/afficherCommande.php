...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Tables commande</h1>
			...
			<?PHP
				$pdo = new PDO('mysql:host=localhost;dbname=dmak', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
				...
				<tr>
					...
					<td><?PHP echo $produit['id_cmd']; ?></td>
					<td><?PHP echo $produit['id_membre']; ?></td>
					<td><?PHP echo $produit['montant']; ?></td>
					<td><?PHP echo $produit['date_enregistrement']; ?></td>
					<td>
						...
						<input type="hidden" value=<?PHP echo $produit['id_cmd']; ?> name="id_cmd">
		...
		?>
			...
			<a class="btn btn-primary" href="tri_cmd.php">Tri</a>	
